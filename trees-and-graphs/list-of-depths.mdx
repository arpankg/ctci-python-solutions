...
use a variable depth and pass depth+1 to next level to keep track of level, this solution is combination of dfs pre-order travel.
...
*Linked list implementaion is naive.
</details>